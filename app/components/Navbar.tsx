...
>
  ...
  <div className="relative w-full">
    {/* 🔍 Search Icon */}
    <div className="absolute right-0 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-auto">
      <svg
        className="w-5 h-5" // slightly larger for better visibility
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
    ...
    <input
      ...
      className="w-full px-4 py-2 pl-12 bg-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all hover:bg-gray-200"
    />
  </div>
</div>
